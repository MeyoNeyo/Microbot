package net.runelite.client.plugins.microbot.apexfighter.skill;
...
public class AttackStyleScript extends Script {
    ...
    private void scheduledTask(ApexFighterConfig config) {
        try {
    ...
    private void changeAttackStyle(ApexFighterConfig config, WidgetInfo attackStyleWidgetInfo) {
    ...
    private void selectSkills(ApexFighterConfig config) {
    ...
    private WidgetInfo getComponentToDisplay(ApexFighterConfig config) {
