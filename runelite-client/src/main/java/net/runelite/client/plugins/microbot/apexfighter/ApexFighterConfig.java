...
import net.runelite.client.plugins.microbot.apexfighter.enums.PlayStyle;
...
//    }
    ...
    */
    ...
    @ConfigItem(
            keyName = "bankingInventoryKeep",
            name = "Banking: Inventory Keep List",
            description = "Comma-separated list of items (optionally with amount after dash) to keep in inventory after banking. Example: Nature runes-500,Iron scimitar,bread-4,raw meat",
            position = 100,
            section = banking
    )
