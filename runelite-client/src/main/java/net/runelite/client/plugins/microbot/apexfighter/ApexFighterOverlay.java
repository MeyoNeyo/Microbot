...
import static net.runelite.client.plugins.microbot.apexfighter.combat.AttackNpcScript.filteredAttackableNpcs;
import static net.runelite.client.plugins.microbot.apexfighter.combat.FlickerScript.currentMonstersAttackingUs;
import static net.runelite.client.ui.overlay.OverlayUtil.renderPolygon;

public class ApexFighterOverlay extends OverlayPanel {
    ...
    private ApexFighterConfig config;

    @Inject
    private ApexFighterOverlay(ModelOutlineRenderer modelOutlineRenderer, ApexFighterConfig config) {
