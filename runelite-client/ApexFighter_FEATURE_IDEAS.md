...
- Display a total profit number above the loot list.
...
## 2. Stop Plugin After Death (Config Toggle)
...
## 3. Anti-PK Escape (Player Attacked by Another Player)
...
## 4. (Add more ideas below as you think of them)
- ...
